        ...
        <Flex width="95%"
            ...
            <Center flex={2} marginTop="3em">
                <AspectRatio width="100%" ratio={16 / 9}>
                    <iframe width="100%" height="100%" src={content.youtubeUrl} title="16 Sesja Linuksowa" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </AspectRatio>
            </Center>
        </Flex>
    </Box>
